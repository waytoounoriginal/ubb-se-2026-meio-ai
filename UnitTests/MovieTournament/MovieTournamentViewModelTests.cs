    ...
    public class MovieTournamentViewModelTests
    {
        ...
        public async Task SetUp()
        {
            ...
            this.mockedTournamentLogicService
                .SetupGet(tournamentLogicService => tournamentLogicService.IsTournamentActive)
                .Returns(false);

            this.mockedTournamentLogicService
                .Setup(tournamentLogicService => tournamentLogicService.IsTournamentComplete())
                .Returns(false);

            this.mockedTournamentRepository
                .Setup(tournamentRepository => tournamentRepository.GetTournamentPoolSizeAsync(UserId))
                .ReturnsAsync(0);

            this.mockedTournamentRepository
                .Setup(tournamentRepository => tournamentRepository.GetTournamentPoolAsync(UserId, BackgroundCount))
        ...
        public async Task InitializeAsync_tournamentIsActive_setsViewStateToMatchAndUpdatesDisplay()
        {
            ...
            this.mockedTournamentLogicService
                .SetupGet(tournamentLogicService => tournamentLogicService.CurrentState)
                .Returns(state);

            this.mockedTournamentLogicService
                .Setup(tournamentLogicService => tournamentLogicService.GetCurrentMatch())
                .Returns(match);
        ...
        public async Task InitializeAsync_tournamentIsComplete_setsViewStateToWinnerAndSetsWinnerMovie()
        {
            ...
            this.mockedTournamentLogicService
                .Setup(tournamentLogicService => tournamentLogicService.GetFinalWinner())
                .Returns(winner);
        ...
        public async Task StartTournamentAsync_validPoolSize_callsServiceAndTransitionsToMatchView()
        {
            ...
            this.mockedTournamentLogicService
                .Setup(tournamentLogicService => tournamentLogicService.StartTournamentAsync(UserId, GoodSize))
        ...
        public async Task StartTournamentAsync_serviceThrows_setsErrorMessageAndStaysInSetupView()
        {
            ...
            this.mockedTournamentLogicService
                .Setup(tournamentLogicService => tournamentLogicService.StartTournamentAsync(UserId, BadSize))
        ...
        [Test]
        public async Task SelectMovieAsync_tournamentComplete_transitionsToWinnerView()
        {
            ...
            this.mockedTournamentLogicService
                .Setup(tournamentLogicService => tournamentLogicService.AdvanceWinnerAsync(UserId, WinnerId))
                .Returns(Task.CompletedTask);
        ...
        [Test]
        public async Task SelectMovieAsync_getCurrentMatchReturnsNull_keepsMatchViewState()
        {
            const int WinnerId = 1;
        ...
        public void ResetTournament_callsServiceAndReturnsToSetupView()
        {
            ...
            this.mockedTournamentLogicService.Verify(tournamentLogicService => tournamentLogicService.ResetTournament(), Times.Once);
        }
